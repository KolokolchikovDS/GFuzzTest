...
# Workaround for CMake 4.x + clang-cl: the auto-emitted -std=c++XX flag is not
# honored by clang-cl (it falls back to C++14), so the source-compile probes
# below would report "C++ < 17" even though the project forces /std:c++latest
# via CMAKE_CXX_FLAGS. Skip the probes and pin the feature to C++20, which is
# what the project's /std:c++latest + _HAS_CXX23=0 configuration provides.
